...
- Clique em <b>New</b> para criar um novo repositório; <br />
    ...
    ![NewRepository](/create-new-repository.png)
...
- Para finalizar, tem a opção de <b>escolher uma licença</b> para que seu repositório seja considerado como código aberto e outros desenvolvedores tenham a liberdade de usar, alterar e distribuir. 
    ![RepositorySettings](/repository-settings.png)